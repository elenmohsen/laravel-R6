                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            ...
                            <div class="product-thumb">
                                <a href="{{route('product.index')}}">
                                    <img src="{{asset('assets/images/'.$product->image) }}" class="img-fluid product-image" alt="" style="width: 400px; height:300px;">
                                </a>
                                 
                                <div class="product-top d-flex">
                                     @if($product['status']=='old')  
                                        <span class="product-alert me-auto" style="display:none;"></span>
                                        <a href="#" class="bi-heart-fill product-icon" style="display:none;"></a>
                                        @else 
