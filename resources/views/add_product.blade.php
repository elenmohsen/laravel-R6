      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('product.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="product title" name="title" class="form-control py-2" value="{{old('title')}}" />
              @error('title')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea name="description" placeholder="short description" id="" cols="30" rows="5" class="form-control py-2" >{{old('description')}}</textarea>
               @error('description')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" placeholder="Enter price" name="price" class="form-control py-2" value="{{old('price')}}"/>
              @error('price')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="product status" name="status" class="form-control py-2" value="{{old('status')}}" />
              @error('status')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
